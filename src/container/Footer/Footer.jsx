...
const Footer = () => (
  <div className="app__footer section__padding" id="contact">
    ...
    <div className="footer__copyright">
      <p className="p__opensans">2022  All Rights reserved. <br />   <span style={{color: '#DCCA87', letterSpacing: '2px', fontFamily: "Cormorant Upright", position:"absolute", left:'600px'}}>    Hasmik Minasyan.</span> </p>
    </div>
